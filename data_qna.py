...
# type7 데이터 입력:
result_data['type7'] = ['먹는 걸을 좋아하고 잘못된 것을 못 참는,','프랑스인, francais','먹는 걸 좋아하고 잘못된 점을 고치는, 프랑스인과 비슷하네요!','당신의 다음 생 국적',"La vie est belle (인생은 아름다워)","France",'프랑스','https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Flag_of_France.svg/150px-Flag_of_France.svg.png','https://ko.wikipedia.org/wiki/%ED%94%84%EB%9E%91%EC%8A%A4']
# type8 데이터 입력:
